...
def _avaliacao_synonyms(av: str) -> List[str]:
    ...
    Ajuste esta tabela conforme seus nomes reais.
    """
    ...
    # atalhos bem frequentes
    if a in {"po", "prova online"} or "prova online" in a:
        base += ["prova online", "online", "po"]
    if a in {"pp", "prova presencial"} or "prova presencial" in a:
        base += ["prova presencial", "presencial", "pp"]
